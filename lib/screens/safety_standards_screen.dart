...
class SafetyStandardsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const LegalPageScaffold(
      ...
      headline: 'XapZap Safety Standards Against CSAE',
      intro:
          'This page sets out XapZap public standards against child sexual abuse and exploitation. It explains the conduct prohibited on XapZap, the obligations users must follow, how reporting works, and the enforcement consequences for any account involved in child sexual abuse or exploitation.',
      currentRoute: '/safety-standards',
      sections: [
        LegalSectionData(
